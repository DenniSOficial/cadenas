      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Editar Buffer</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-12">
          <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title">Editar Buffer</h3>
            </div>
                @include('admin.mantenimiento.buffer.form', ['url' => 'admin/mantenimiento/buffer/update/' . $buffer->Id, 'method' => 'POST']) 
          </div>
        </div>
      </div>
    </div>
