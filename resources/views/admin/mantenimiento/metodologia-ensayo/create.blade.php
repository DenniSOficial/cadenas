...
@section('content')
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Nueva Metodología de Ensayo</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{ route('admin') }}">Mantenimiento</a></li>
            <li class="breadcrumb-item active">Nueva Metodología de Ensayo</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-12">
          <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title">Crear Metodología de Ensayo</h3>
            </div>
                @include('admin.mantenimiento.metodologia-ensayo.form', ['url' => 'admin/mantenimiento/metodologia-ensayo/store', 'method' => 'POST']) 
          </div>
        </div>
      </div>
    </div>
