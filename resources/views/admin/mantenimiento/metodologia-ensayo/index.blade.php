      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <a href="{{ route('mantenimiento.metodologia-ensayo.create') }}" class="btn btn-primary">Registrar</a>
              <table id="tblCadenaCustodia" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  @foreach ($metodologias as $metodologia)
                      <tr>
                          <td>{{ $nr }}</td>
                          <td>{{ $metodologia->Ensayo }}</td>
                          <td>{{ $metodologia->Metodo }}</td>
                          <td>{{ $metodologia->abruni  }}</td>
                          <td> @include('admin.mantenimiento.metodologia-ensayo.delete', ['metodologia' => $metodologia]) </td>
                      </tr>
                      <?php $nr++; ?>
                  @endforeach
                </tbody>
