{{ Form::open(['id' => 'frmDeleteCadenaDetalle', 'url' => 'admin/ruido/detalle/delete/'.$codigo->Id, 'method' => 'DELETE']) }}
    <center>
        {{-- <a href="{{ route('ruido.show', $codigo->Id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a> --}}
        <a href="{{ route('ruido.detalle.edit', $codigo->Id) }}" class="btn btn-warning btn-sm" title="Editar"><i class="fa fa-edit" aria-hidden="true"></i></a>
