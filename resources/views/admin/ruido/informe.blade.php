      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-info">
            ...
            {{ Form::open(['url' => '/admin/ruido/informe/' . $cadena->Id, 'method' => 'POST', 'class' => ['form-horizontal formAjax'], 'id' => 'formCadenaCusodia', 'novalidate' => true , 'autocomplete' => 'off', 'onkeydown' => 'return event.key != "Enter";' , 'onsubmit' => 'return validateForm();' ]) }}
                {!! Form::token() !!}
                <div class="card-body">
               <input type="hidden" name="id" value="{{ $cadena->Id }}">
                ...
                <div class="form-group row">
                  <label for="fecha_muestra" class="col-sm-2 col-form-label">Fecha recepción de muestras</label>
                  <div class="col-sm-10">
                  <input type="date" class="form-control" id="fecha_muestra" name="fecha_muestra" value="{{ isset($cadena->FechaRecepcionMuestra) ? $cadena->FechaRecepcionMuestra : '' }}">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-5">
                  <input type="date" class="form-control" id="fecha_medicion_1" name="fecha_medicion_1" value="{{ isset($cadena->FechaMuestreoMedicion) ? $cadena->FechaMuestreoMedicion : '' }}">
                  </div>
                  <div class="col-sm-5">
                    <input type="date" class="form-control" id="fecha_medicion_2" name="fecha_medicion_2" value="{{ isset($cadena->FechaMuestreoMedicion_2) ? $cadena->FechaMuestreoMedicion_2 : '' }}">
                    </div>
                </div>
