      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ route('agua.show', $cadena->Id) }}">{{ $cadena->NumeroCotizacion }} </a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-info">
            ...
            @include('admin.agua.detalle.form', ['url' => 'admin/agua/detalle/' . $detalle->IdCadenaCustodiaAgua . '/update/' . $detalle->Id, 'method' => 'POST'])
          </div>
        </div>
      </div>
    </div>
...
@section('js')
  ...
  <script type = "text/javascript">
    ...
    function validateForm() {
      ...
      var tipo_matriz = $('#tipo_matriz').val();
      ...
      if (tipo_matriz === '') {
        Swal.fire({
          icon: 'warning',
          title: 'Sistemas Análiticos Generales',
          text: 'Debe de ingresar el tipo de matriz.'
        });
        return false;
      }
