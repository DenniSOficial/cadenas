      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Potenciometro</li>
          </ol>
        </div>
      </div>
    </div>
          ...
          <div class="card card-info">
            ...
            {{ Form::open(['url' => route('agua.verificacion-operacional.update', $cadena->Id), 'method' => 'POST', 'class' => ['form-horizontal formAjax'], 'id' => 'formCadenaCusodia', 'novalidate' => true , 'autocomplete' => 'off', 'onkeydown' => 'return event.key != "Enter";' , 'onsubmit' => 'return validateForm();' ]) }}
                ...
                <div class="card-body">
                  ...
                  <input type="hidden" class="form-control" name="id" id="id" value="{{ isset($potenciometro) ? $potenciometro->Id : '0' }}">  
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                          <input type="text" class="form-control" name="marca_equipo" id="marca_equipo" value="{{ isset($potenciometro) ? $potenciometro->MarcaEquipo : '' }}">
                      </div>
                      <label class="col-sm-2 col-form-label">Slope Optimo</label>
                      <div class="col-sm-2">
                          <input type="text" class="form-control" name="slope_optimo" id="slope_optimo" value="{{ isset($potenciometro) ? $potenciometro->SlopeOptimo : '' }}">
                      </div>
                      <label class="col-sm-2 col-form-label">Codigo Equipo</label>
                      <div class="col-sm-2">
                          <input type="text" class="form-control" name="codigo_equipo" id="codigo_equipo" value="{{ isset($potenciometro) ? $potenciometro->CodigoEquipo : '' }}">
                      </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                        <div class="table-responsive">
                            <table id="tblAjuste" class="table table-bordered" style="text-align: center;">
                                ...
                                <tbody>
                                  @isset($potenciometro)
                                      @foreach ($potenciometro->ajuste as $ajuste)
                                          <tr>
                                            ...
                                            <td><input type="hidden" name="ajuste_valor[]" value="{{ $ajuste->ValorpHTeorico }}" />{{ $ajuste->ValorpHTeorico }}</td>
                            ...
                            <table id="tblControl" class="table table-bordered" style="text-align: center;">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>Lote</th>
                                        <th>Valor pH Teórico</th>
                                        <th>Valor pH Control</th>
                                        <th>X</th>
                                    </tr>
                                </thead>
                                <tbody>
                                  @isset($potenciometro)
                                      @foreach ($potenciometro->control as $control)
                                          <tr>
                                            ...
                                            <td><input type="hidden" name="control_valort[]" value="{{ $control->ValorpHTeorico }}" />{{ $control->ValorpHTeorico }}</td>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" name="slope" id="slope" value="{{ isset($potenciometro) ? $potenciometro->Slope : '' }}">
                        </div>
                    </div>
