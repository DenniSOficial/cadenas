      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Turbiedad</li>
          </ol>
        </div>
      </div>
    </div>
          ...
          <div class="card card-info">
            ...
            {{ Form::open(['url' => route('agua.verificacion-operacional.update', $cadena->Id), 'method' => 'POST', 'class' => ['form-horizontal formAjax'], 'id' => 'formCadenaCusodia', 'novalidate' => true , 'autocomplete' => 'off', 'onkeydown' => 'return event.key != "Enter";' , 'onsubmit' => 'return validateForm();' ]) }}
                ...
                <div class="card-body">
                  ...
                  <input type="hidden" class="form-control" name="id" id="id" value="{{ isset($turbiedad) ? $turbiedad->Id : '0' }}">  
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                          <input type="text" class="form-control" name="codigo_equipo" id="codigo_equipo" value="{{ isset($turbiedad) ? $turbiedad->CodigoEquipo : '' }}">
                      </div>
                  </div>

                  <h5 style="font-weight: bold;">Método: SM 2130 B</h5> 
                            ...
                            <table id="tblAjuste" class="table table-bordered" style="text-align: center;">
                                <thead>
                                    ...
                                    <tr>
                                        <th>Marca</th>
                                        <th>Lote</th>
                                        <th>Valor de Turbiedad NTU</th>
                                        <th>X</th>
                                    </tr>
                                </thead>
                                <tbody>
                                  @isset($turbiedad)
                                      @foreach ($turbiedad->ajuste as $ajuste)
                                          <tr>
                                            ...
                                            <td><input type="hidden" name="ajuste_valor[]" value="{{ $ajuste->ValorTeorico }}" />{{ $ajuste->ValorTeorico }}</td>
                            ...
                            <table id="tblControl" class="table table-bordered" style="text-align: center;">
                                <thead>
                                    ...
                                    <tr>
                                        <th>Marca</th>
                                        <th>Lote</th>
                                        <th>Valor Teórico NTU</th>
                                        <th>Rango de aceptación +/-</th>
                                        <th>Lectura del control NTU</th>
                                        <th>X</th>
                                    </tr>
                                </thead>
                                <tbody>
                                  @isset($turbiedad)
                                      @foreach ($turbiedad->control as $control)
                                          <tr>
                                            ...
                                            <td><input type="hidden" name="control_valort[]" value="{{ $control->ValorTeorico }}" />{{ $control->ValorTeorico }}</td>
                  ...
                  {{-- 
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" name="slope" id="slope" value="{{ isset($turbiedad) ? $turbiedad->Slope : '' }}">
                        </div>
                    </div> --}}
