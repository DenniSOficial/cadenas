      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Radiacion</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Cadena de Custodia de Monitoreo de Radiacion</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <a href="{{ route('radiacion.create') }}" class="btn btn-primary">Registrar</a>
                ...
                <tbody>
                  ...
                  @foreach ($cadenas as $cadena)
                      <tr>
                          ...
                          <td> @include('admin.radiacion.delete', ['cadena' => $cadena]) </td>
                      </tr>
                      <?php $nr++; ?>
                  @endforeach
                </tbody>
